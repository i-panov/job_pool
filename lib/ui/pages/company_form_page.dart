...
class CompanyFormPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final state = ref.watch(companyFormProvider(companyId));
    final form = ref.read(companyFormProvider(companyId).notifier);
          ...
          child: Column(
            ...
            children: [
              TextFormField(
                ...
                onEditingComplete: form.validateName,
              ),
              Row(
                spacing: 30,
                children: [
              ...
              Row(
                ...
                children: [
                  Text('Ссылки'),
                  IconButton(icon: Icon(Icons.add), onPressed: form.addLink),
                ],
              ),
